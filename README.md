...
- Copy all files from src/qt to the project folder. To add them to the project right click on *Source Files* and then *add existing files*
...
- Accept the default password length (for now)

Next you need to visit each service and change your old password to the new strong password generated by the program

Any time you need a password (having confirmed that you are on a legitimate service login page), restart the program
